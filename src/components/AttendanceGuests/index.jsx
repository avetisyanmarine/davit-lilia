...
const AttendanceGuests = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch(
        "https://script.google.com/macros/s/AKfycbyYkr98MIjOwKVxgqvw45xFe1f1pff0N2Txzxe20XtqZZoQa0lT80PoifnIw0Pmw3O8Hg/exec",
        {
          method: "POST",
          mode: "no-cors",
          headers: {
  ...
  return (
    <Wrapper>
      ...
      <Header>
        ...
        <p>Խնդրում ենք հաստատել Ձեր մասնակցությունը մինչև 10․07․26</p>
      </Header>
